...
<style lang="sass">
	.con {
		...
		.top {
			...
			top: 0px;
			left: 0px;
			border-top: 1px solid #aab0c6;
			border-left: 0px solid #aab0c6;
			border-radius: 50%;
			z-index: 5;
		...
		.left {
			...
			bottom: 0px;
			left: 0px;
			border-bottom: 0px solid #aab0c6;
			border-left: 1px solid #aab0c6;
			border-radius: 50%;
			z-index: 5;
		...
		.right {
			...
			top: 0px;
			right: 0px;
			border-top: 0px solid #aab0c6;
			border-right: 1px solid #aab0c6;
			border-radius: 50%;
			z-index: 5;
		...
		.top-on {
			border-top: 5px solid #aab0c6;
			border-left: 5px solid #aab0c6;
			width: 95px;
			height: 95px;
		}
		.bottom-on {
			border-bottom: 5px solid #aab0c6;
			border-right: 5px solid #aab0c6;
			width: 95px;
			height: 95px;
		}
		.left-on {
